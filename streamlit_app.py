...
def load_and_process_data():
    ...
    # GeoJSON 매칭을 위한 지역명 맵핑 강화 (GeoJSON 파일에서 사용하는 긴 지역명)
    region_name_map = {
...
# -------------------------------------------------------------
# 5-2. 자료유형별 연간 추세 (Stacked Bar Chart 고정) - 이전과 동일
# -------------------------------------------------------------
...
# -------------------------------------------------------------
# 5-3. 연령별 연간 추세 (Grouped Bar Chart) - 이전과 동일
# -------------------------------------------------------------
...
# -------------------------------------------------------------
# 5-4. 주제별 연간 추세 (Line Chart) - 이전과 동일
# -------------------------------------------------------------
